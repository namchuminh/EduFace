            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Nhập Thông Tin Lớp Học Phần</h3>
                    </div>

                    <form action="{{ route('course_classes.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control @error('student_count') is-invalid @enderror" 
                                    name="student_count" value="0" 
