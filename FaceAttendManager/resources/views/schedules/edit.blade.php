        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('schedules.update', $schedule->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="course_class_id" class="form-control @error('course_class_id') is-invalid @enderror" required>
                            ...
                            @foreach ($courseClasses as $class)
                                <option value="{{ $class->id }}" {{ old('course_class_id', $schedule->course_class_id) == $class->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        <label>Ngày</label>
                        <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date', $schedule->date) }}" required>
                        @error('date')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label>Phòng</label>
                        <input type="text" name="room" class="form-control @error('room') is-invalid @enderror" placeholder="Nhập phòng học" value="{{ old('room', $schedule->room) }}">
                        @error('room')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
